...
final class CasperSDKInSwiftTests: XCTestCase {
    ...
    func testAll() throws {
        ...
        do {
            getStateRootHashParam.blockIdentifier = .hash("20e6cf8001a9456e9e202f0923393b1f551470934683800f62d11c1685d4710d")
            try casperSDK.getStateRootHash(getStateRootHashParam: getStateRootHashParam)
        } catch {
            throw error
        }
        ...
        do {
            getStateRootHashParam.blockIdentifier = .height(473861)
            try casperSDK.getStateRootHash(getStateRootHashParam: getStateRootHashParam)
        } catch {
            throw error
        }
        ...
        do {
            getStateRootHashParam.blockIdentifier = .height(473861000)
            try casperSDK.getStateRootHash(getStateRootHashParam: getStateRootHashParam)
        } catch {
            throw error
        }
        ...
        do {
             let deployHash: String = "AaB4aa0C14a37Bc9386020609aa1CabaD895c3E2E104d877B936C6Ffa2302268"
              ...
              getDeployParam.deployHash = deployHash
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(448471)
            try casperSDK.getBlockTransfers(input: blockIdentifier)
        }  catch {
            throw error
        }
        // 5.2 get block transfer by block hash
        do {
            let blockIdentifier: BlockIdentifier = .hash("ae173969cb6ce3c99439c81e5b803c15797a8559796d980daa99f52beb7192e3")
            try casperSDK.getBlockTransfers(input: blockIdentifier)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(4484710000)
            try casperSDK.getBlockTransfers(input: blockIdentifier)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .hash("FFEAE393969cb6ce3c99439c81e5b803c15797a8559796d980daa99FFE2beb7192e3")
            try casperSDK.getBlockTransfers(input: blockIdentifier)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier2: BlockIdentifier = .hash("830fd58dd08189981d7535fc9de0606bc789b2c8ef2af895ebce5ffc23c4530e")
            try casperSDK.getBlock(input: blockIdentifier2)
        }  catch {
            throw error
        }
        // 6.2. get block with block height
        do {
            let blockIdentifier: BlockIdentifier = .height(449797)
            try casperSDK.getBlock(input: blockIdentifier)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier2: BlockIdentifier = .hash("FFCC0fd58dd08189981d7535fc9de0606bc789b2c8ef2af895ebce5ffc23c4530e")
            try casperSDK.getBlock(input: blockIdentifier2)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(44979700000)
            try casperSDK.getBlock(input: blockIdentifier)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(441636)
            try casperSDK.getEraBySwitchBlock(input: blockIdentifier)
        } catch {
            throw error
        }
        // 7.2. get era by block hash
        do {
            let blockIdentifier: BlockIdentifier = .hash("449a2570d5b8c4480565d05bfa17e3cd4249fcf6570132a4f8031fbc24cffb71")
            try casperSDK.getEraBySwitchBlock(input: blockIdentifier)
        } catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(4416360000)
            try casperSDK.getEraBySwitchBlock(input: blockIdentifier)
        } catch {
            throw error
        }
        ...
        // Error: CasperError(code: -32001, message: "block not known", methodCall: "chain_get_block")
        do {
            let blockIdentifier: BlockIdentifier = .hash("FFGG2570d5b8c4480565d05bfa17e3cd4249fcf6570132a4f8031fbc24cffb71")
            try casperSDK.getEraBySwitchBlock(input: blockIdentifier)
        } catch {
            throw error
        }
        ...
        do {
           ...
           //  getStateItemParam.key = "uref-ba620eee2b06c6df4cd8da58dd5c5aa6d42f3a502de61bb06dc70b164eee4119-007"
            ...
            // Withdraw
            getStateItemParam.stateRootHash = "d360e2755f7cee816cce3f0eeb2000dfa03113769743ae5481816f3983d5f228"
        ...
        do {
            let getStateItemParam: GetItemParams = GetItemParams()
            getStateItemParam.stateRootHash = "MMM0e2755f7cee816cce3f0eeb2000dfa03113769743ae5481816f3983d5f228"
            getStateItemParam.key = "withdraw-df067278a61946b1b1f784d16e28336ae79f48cf692b13f6e40af9c7eadb2fb1"
            try casperSDK.getItem(input: getStateItemParam)
        } catch {
            throw error
        ...
        // 9.1. test with correct parameter
         do {
             ...
             getDic.stateRootHash = "146b860f82359ced6e801cbad31015b5a9f9eb147ab2a449fd5cdb950e961ca8"
             getDic.dictionaryIdentifier = DictionaryIdentifier.accountNamedKey(key: "account-hash-ad7e091267d82c3b9ed1987cb780a005a550e6b3d1ca333b743e2dba70680877", dictionary_name: "dict_name", dictionary_item_key: "abc_name")
            ...
            //  getDic.dictionary_identifier = DictionaryIdentifier.URef(seed_uref: "uref-30074a46a79b2d80cff437594d2422383f6c754de453b732448cc711b9f7e129-007", dictionary_item_key: "abc_name")
             getDic.dictionaryIdentifier = DictionaryIdentifier.dictionary("dictionary-5d3e90f064798d54e5e53643c4fce0cbb1024aadcad1586cc4b7c1358a530373")
        ...
        do {
            let getDic: GetDictionaryItemParams = GetDictionaryItemParams()
            getDic.stateRootHash = "146b860f82359ced6e801cbad31015b5a9f9eb147ab2a449fd5cdb950e961ca8"
            getDic.dictionaryIdentifier = DictionaryIdentifier.accountNamedKey(key: "account-hash-AAFF091267d82c3b9ed1987cb780a005a550e6b3d1ca333b743e2dba70680877", dictionary_name: "dict_name", dictionary_item_key: "abc_name")
             try casperSDK.getDictionaryItem(from: getDic)
        }  catch {
            throw error
        }
        ...
        do {
            ...
            getBP.stateRootHash = "8b463b56f2d124f43e7c157e602e31d5d2d5009659de7f1e79afbd238cbaa189"
            getBP.purseUref = "uref-be1dc0fd639a3255c1e3e5e2aa699df66171e40fa9450688c5d718b470e057c6-007"
        ...
        do {
            let getBP: GetBalanceParams = GetBalanceParams()
            getBP.stateRootHash = "8b463b56f2d124f43e7c157e602e31d5d2d5009659de7f1e79afbd238cbaa189"
            getBP.purseUref = "uref-FF1dc0fd639a3255c1e3e5e2aa699df66171e40fa9450688c5d718b470e057c6-007"
            try casperSDK.getStateBalance(input: getBP)
        }  catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .hash("cb8dab9f455538bc6cedb217a6234faeece8ce32c94d053b5b770450290b3a30")
            try casperSDK.getAuctionInfo(input: blockIdentifier)
        } catch {
            throw error
        }
        // 11.2 test with correct block height parameter
        do {
            let blockIdentifier: BlockIdentifier = .height(473576)
            try casperSDK.getAuctionInfo(input: blockIdentifier)
        } catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .hash("FF8Eab9f455538bc6cedb217a6234faeece8ce32c94d053b5b770450290b3a30")
            try casperSDK.getAuctionInfo(input: blockIdentifier)
        } catch {
            throw error
        }
        ...
        do {
            let blockIdentifier: BlockIdentifier = .height(4735760000)
            try casperSDK.getAuctionInfo(input: blockIdentifier)
        } catch {
            throw error
        }
