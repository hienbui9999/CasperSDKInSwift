//
//  GetDictionaryItem.swift
//  SampleRPCCall1
//
//  Created by Hien on 11/12/2021.
//
//https://docs.rs/casper-node/latest/casper_node/rpcs/state/struct.GetDictionaryItem.html
//DATA BACK
/*
 ["error": {
     code = "-32602";
...
class GetDictionaryItem {
    let methodStr : String = "state_get_dictionary_item"
    let methodURL : String = "http://65.21.227.180:7777/rpc"
    func handle_request () {
        print("state_get_dictionary_item")
