...
final class TestDeploySerialization: XCTestCase {
    func testAll() throws {
        do {
            ...
            oneNamedArg.argsItem.cl_type = CLType.U512
            ...
            oneNamedArg0.argsItem.cl_type = CLType.U512
            ...
            let module_bytes:Bytes = Bytes.fromStrToBytes(from: "123456789123456789123456789123456789123456789123456789")
            let edi0:ExecutableDeployItem = .ModuleBytes(module_bytes: module_bytes, args: runtimeArgs0)
            ...
            let edi2:ExecutableDeployItem = .StoredContractByHash(hash: "c4c411864f7b717c27839e56f6f1ebe5da3f35ec0043f437324325d65a22afa4", entry_point: "pclphXwfYmCmdITj8hnh", args: runtimeArgs0)
            ...
            oneNamedArg1.argsItem.cl_type = CLType.I32
            ...
            let payment:ExecutableDeployItem = .StoredContractByName(name: "casper-example", entry_point: "example-entry-point", args: runtimeArgs1)
            ...
            let edi3 : ExecutableDeployItem = .StoredVersionedContractByHash(hash: "b348fdd0d0b3f66468687df93141b5924f6bb957d5893c08b60d5a78d0b9a423", version: nil, entry_point: "PsLz5c7JsqT8BK8ll0kF", args: runtimeArgs0)
            ...
            let edi4 : ExecutableDeployItem = .StoredVersionedContractByName(name: "lWJWKdZUEudSakJzw1tn", version: 1632552656, entry_point: "S1cXRT3E1jyFlWBAIVQ8", args: runtimeArgs0)
            ...
            oneNamedArg2.argsItem.cl_type = CLType.I32
