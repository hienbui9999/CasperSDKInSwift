...
let casperId: Int32 = 1
let casperRpcVersion: String = "2.0"
/**
...
public class CasperSDK {
    ...
    public func getStateRootHash(getStateRootHashParam: GetStateRootHashParam) throws {
        let data = JsonConversion.fromBlockIdentifierToJsonData(input: getStateRootHashParam.blockIdentifier, method: .chainGetStateRootHash)
        do {
